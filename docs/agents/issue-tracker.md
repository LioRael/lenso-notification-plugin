...
Read the complete ticket, comments, labels, assignees, blockers, and linked
pull requests before changing tracker state. Keep the central ticket open until
the implementation pull request merges.
